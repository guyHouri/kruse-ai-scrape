...
| `code/summarize.js` | Anthropic API caller, JSON parse/validation, raw dumps |
...
- AI JSON parse/validation failures write `out/<date>-ai-raw.txt`; inspect that
  file before making another API call.
